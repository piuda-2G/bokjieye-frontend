...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MyViewHolder> {
    ...
    @Override public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        System.out.println("isReceived called"+isReceived);
        if(isReceived){ //isReceived == true 응답 (답장) 보여줌
            holder.messageReceive.setVisibility(View.VISIBLE);
            holder.messageSend.setVisibility(View.GONE);
            holder.pomiimg.setVisibility(View.VISIBLE);
            holder.messageReceive.setText(message);
        }else {
            holder.messageSend.setVisibility(View.VISIBLE);
            holder.messageReceive.setVisibility(View.GONE);
            holder.pomiimg.setVisibility(View.GONE);
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        MyViewHolder(@NonNull View itemView) {
            ...
            pomiimg = itemView.findViewById(R.id.pomi);
        }
    }
